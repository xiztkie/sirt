<x-app-layout :title="$title" :active="$active" :subtitle="$subtitle">
    <div class="card bg-white border border-base-200 shadow-sm p-6">
        <div class="mb-6">
            <h3 class="text-xl font-semibold">Daftar Keluarga</h3>
        ...
        <div class="flex flex-col md:flex-row justify-between gap-4 mb-6">
            ...
            <form id="searchForm" action="{{ route('penduduk.keluarga') }}" method="GET">
                <div class="relative w-full">
                    <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Cari keluarga..."
            ...
            <table class="table-xs table table-zebra">
                <thead class="bg-base-100 text-sm ">
                    <tr>
                        ...
                        <th class="py-4">No Kartu Keluarga</th>
                        <th class="py-4">Kepala Keluarga</th>
                ...
                <tbody>
                    @php
                        $no = ($keluarga->currentPage() - 1) * $keluarga->perPage() + 1;
                    @endphp
                        ...
                        <tr class="row-hover">
                            ...
                            <td class="flex justify-center">
                                <button type="button" class="btn btn-text p-1 text-red-500" aria-haspopup="dialog"
                                    aria-expanded="false" aria-controls="delete-modal-{{ $item->id }}"
                                    data-overlay="#delete-modal-{{ $item->id }}" title="Hapus">
